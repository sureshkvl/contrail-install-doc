...
config.networkManager.ip = '10.0.1.6';
...
config.imageManager = {};
config.imageManager.ip = '10.0.1.6';
...
config.computeManager.ip = '10.0.1.6';
...
config.identityManager = {};
config.identityManager.ip = '10.0.1.6';
...
config.storageManager.ip = '10.0.1.6';
...
/* Cassandra Server */
config.cassandra = {};
config.cassandra.server_ips = ['10.0.1.3'];
