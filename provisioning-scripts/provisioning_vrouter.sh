...
/usr/share/contrail-utils/provision_vrouter.py --api_server_ip $API_SERVER_IP \
...
/usr/share/contrail-utils/provision_control.py --host_name $CONTRAIL_HOSTNAME --host_ip $API_SERVER_IP \
...
#                                        --oper <add | delete>
/usr/share/contrail-utils/provision_linklocal.py --api_server_ip $API_SERVER_IP \
